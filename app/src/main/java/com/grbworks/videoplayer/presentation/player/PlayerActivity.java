package com.grbworks.videoplayer.presentation.player;
...
import com.grbworks.videoplayer.app.PlayerApplication;
import com.grbworks.videoplayer.data.database.AppDatabase;
import com.grbworks.videoplayer.data.model.VideoSource;
import com.grbworks.videoplayer.presentation.Home;
import com.grbworks.videoplayer.presentation.player.util.PlayerController;
import com.grbworks.videoplayer.presentation.player.util.VideoPlayer;
...
public class PlayerActivity extends AppCompatActivity implements View.OnClickListener, PlayerController {
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed();
        startActivity(new Intent(PlayerActivity.this, Home.class));
        finish();
    }
